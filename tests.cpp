...
TEST_CASE( "Testing heap implementation", "[Heap]" ) {
	...
	SECTION( "3: Putting an element in the heap." ) {
		...
		heap.push(1);
		REQUIRE(strcmp(heap.toString().c_str(), "[10 1]") == 0);
		heap.push(5);
		REQUIRE(strcmp(heap.toString().c_str(), "[10 1 5]") == 0);
	...
	SECTION( "4: Removing an element in the heap." ) {
		...
		CHECK(strcmp(heap.toString().c_str(), "[10 1 5]") == 0);
		//heap.clear();
	...
	SECTION( "5: Removing an element in the heap." ) {
		...
		x = heap.pop();
		REQUIRE(x == 10);
		REQUIRE(strcmp(heap.toString().c_str(), "[5 1]") == 0);
		x = heap.pop();
		REQUIRE(x == 5);
		REQUIRE(strcmp(heap.toString().c_str(), "[1]") == 0);
		x = heap.pop();
		REQUIRE(x == 1);
		//REQUIRE(strcmp(heap.toString().c_str(), "[]") == 0);
